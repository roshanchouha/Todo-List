...
const Other = () => {
    ...
    const getTaskDetail = async () => {
        let result = await fetch(`http://localhost:4500?category="Other"&UID=${UID}`);
                ...
                <div className='Mobile'>
                    <div className='heading '>
                        ...
                        <div className='PHead m-4' >
                            <div>
                                <img className='sun' src={other} alt="" width="40px" height="40px" />
                            </div>
                            <div className='PDetail'>
                                <h4 className='mt-3'> {tasks.length} Task</h4>
                                <h1 className='task2'>Other</h1>
                            </div>
