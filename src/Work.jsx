...
import planned from './image/suitcase.png';
...
const Work = () => {
    ...
    const getTaskDetail = async () => {
        let result = await fetch(`http://localhost:4500?category="Work"&UID=${UID}`);
