...
import planned from './image/sun.png';
...
let  Del;
let Ttask;
const allTask1 = (value) => {
    Ttask = value;
}
function TaskItem({ task, onDelete,onDelete2 }) {
...
const Today = () => {
    ...
    const getTaskDetail = async () => {
        let result = await fetch(`http://localhost:4500/all?date="${DTime}"&UID=${UID}`);
     ...
     <div>
            <div className='contain'>
                ...
                <div className='Start'>
                    ...
                    <div className='add'>
                        {/* <img src=<ControlPo></ControlPo>intIcon /> alt="" width="40px" height="40px"   /> */}
