...
import planned from './image/bussiness-man.png';
...
const Personal = () => {
    ...
    const getTaskDetail = async () => {
        let result = await fetch(`http://localhost:4500?category="Personal"&UID=${UID}`);
                ...
                <div className='Mobile'>
                    <div className='heading '>
                        ...
                        <div className='PHead m-4' >
                            <div>
                                <img className='sun' src={planned} alt="" width="40px" height="40px" />
                            </div>
                            <div className='PDetail'>
                                <h4 className='mt-3'> {tasks.length} Task</h4>
                                <h1 className='task2'>Personal</h1>
                            </div>
...
//     const getTaskDetail = async () => {
//         let result = await fetch(`http://localhost:4500?category="Personal"`);
//         result = await result.json();
//         setTask(result);
//         console.log(result);
...
//                             </div>
//                             <div className='PDetail'>
//                                 <h4 className='mt-3'> {task.length} Task</h4>
//                                 <h1 className='task2'>Personal</h1>
//                             </div>
...
//                         <div className='tasks'>
//                             {
//                                 Array.isArray(task) ? (task.map((val, index) => {
//                                     return (
//                                         <>
//                                             <div className='taskDisplay' >
//                                                 <input className='Box' type="checkbox" />
//                                                 <div className='TaskContain'>{val.task}</div>
//                                                 <button className=' btn btn-warning' onClick={() => deletTask(val.TID)}> <DeleteOutlineIcon className='fs-2' /> </button>
//                                             </div>
//                                         </>
//                                     )
//                                 })) : (
...
//                     </div>
//                     <div className='add'>
//                         <img src={Add} alt="" width="40px" height="40px" onClick={OpenAddLink} />
//                     </div>
//                 </div>
//             </div>
//         </div>
